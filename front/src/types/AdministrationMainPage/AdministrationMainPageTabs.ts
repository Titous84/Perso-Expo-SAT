...
export const ADMINISTRATION_MAIN_PAGE_TABS: AdministrationMainPageTab[] = [
  ...
  },
  {
    ...
    primaryText: 'Juges',
    secondaryText:
      'Création, modification, suppression, liste noire et liste des juges',
   ...
   */
  {
    ...
    secondaryText: "Créer, modifier et supprimer des catégories d'équipes",
    componentToDisplayInContentZone: CategoriesListPage,
    icon: Folder,
  ...
  },
  {
    ...
    secondaryText:
      "Créer, modifier et supprimer des modèles de grilles d'évaluation",
  ...
  },
  {
    ...
    secondaryText:
      'Ajouter et supprimer des administrateurs et modifier leur mot de passe',
