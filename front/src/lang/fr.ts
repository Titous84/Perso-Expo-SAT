 ...
 * Author: Mathieu Sévégny, Tristan Lafontaine, Jean-Philippe Bourassa et Nathan Reyes
 */
export const TEXTS = {
  judgeList: {
    ...
    category: 'Catégorie',
    error:
      'Une erreur est survenue lors de la récupération des juges. Veuillez réessayer plus tard.',
  ...
  informations: {
    title: 'Informations',
    error:
      'Une erreur est survenue lors de la récupération des informations. Veuillez réessayer plus tard.',
    buttons: {
  ...
  modifyPassword: {
    ...
    invalide:
      'Le nouveau mot de passe et la vérification de votre nouveau mot de passe ne sont pas les mêmes',
    email: {
      label: 'Courriel',
      error: {
  ...
  signup: {
    ...
    email: {
      ...
      errorContactPerson: {
        invalide:
          'Le courriel est invalide. Le format doit être le suivant : @cegepvicto.ca ',
      },
    },
    numeroDa: {
      label: 'Numéro DA',
      error: {
        ...
        maximum: 'Le numéro DA doit contenir 7 chiffres',
        invalid: 'Le numéro DA doit contenir exactement 7 chiffres',
      },
    },
    pictureConsent: {
      label:
        "Je consens à être pris en photo et j'autorise le comité à les utiliser pour faire de la publicité future (site web, médias sociaux, journaux, etc.)",
      yes: 'Oui',
      no: 'Non',
    },
    anonymousRegistration: {
      label:
        'Je consens à partager mes informations (numéro de DA, prénom, nom).', // @author Nathan Reyes
      cguLink: '/cgu/consentement-renseignements-personnels.html', // @author Nathan Reyes
      cguTooltip: 'Consulter les CGU', // @author Nathan Reyes
    },
    photoConsent: {
      title: 'Consentement à la prise de photos :', // @author Nathan Reyes
      publication:
        "J'autorise l'utilisation des photos pour la promotion (site web, médias sociaux, journaux, etc.).", // @author Nathan Reyes
      internalUse:
        "J'autorise l'utilisation des photos à des fins internes et pédagogiques.", // @author Nathan Reyes
      totalRefusal:
        'Je ne consens pas à ce que des photos de moi soient publiées.', // @author Nathan Reyes
      errorRequired: 'Veuillez choisir une option de consentement photo.',
    },
    buttons: {
  ...
  survey: {
    ...
    surveyNotFound:
      "Aucun formulaire d'évaluation n'a pu être trouvé avec le jeton fourni.",
    noSurveySectionFound:
      "Les sections du formulaire d'évaluation n'ont pas pu être trouvées.",
    ...
    textCompleteSurvey:
      "Soumettre définitivement les formulaires d'évaluations",
    ...
    surveyCompletedConfirmation:
      "Vous avez bien remis vos formulaires d'évaluation !",
  ...
  evaluationGridForm: {
    ...
    description:
      "Les modèles de grilles seront utilisés pour générer les questionnaires d'évaluations des projets destinés aux juges lors de l'Expo SAT.",
    name: {
      label: 'Nom du modèle',
      error: {
  ...
  signUpSuccess: {
    ...
    content:
      'Votre équipe a bien été inscrite avec les informations suivantes :',
    teamTitle: 'Titre : ',
  ...
  footer: {
    linkPageOfficiel:
      "Page officielle de l'exposition Sciences Arts et Technologies",
