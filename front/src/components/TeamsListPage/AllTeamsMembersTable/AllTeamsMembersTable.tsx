    ...
    return (
      <>
        ...
        <ConfirmationDialog
          ...
          content={
            'Êtes-vous sûr de vouloir supprimer les membres sélectionnés?'
        ...
        <DataGrid<ITeamsMember>
          ...
          slots={{
            ...
            toolbar: (
              props, // `toolbar` fourni un `props` qui contient des données comme les rangées du tableau sélectionnées, etc.
            ) => (
