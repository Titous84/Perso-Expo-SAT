...
export default function AdministratorsTable() {
    ...
    // Variables d'état pour la fenêtre contextuelle de modification du mot de passe
            ...
            renderCell: (params) => {
                return (
                    <Button
                        ...
                        color="primary"
                        onClick={() => {
                            setSelectedAdminEmail(params.row.email);
    ...
    return (
        <div data-testid="administratorsTable">
            ...
            {/* Fenêtre contextuelle de modification du mot de passe cachée par défaut */}
            {/* @author Léandre Kanmegne - H26 */}
            <AdministratorPasswordDialog
                parentIsDialogOpen={isPasswordDialogOpen} // Partager à l'enfant la valeur de la variable d'état pour qu'il sache si a fenêtre contextuelle de modification du mot de passe doit être affichée.
                parentSetIsDialogOpen={setIsPasswordDialogOpen} // Passer une référence de la méthode de changement de la variable d'état pour que l'enfant puisse la déclencher.
                parentSetSnackbarMessage={setSnackbarMessage} // Passer une référence de la méthode de changement de la variable d'état pour que l'enfant puisse la déclencher.
                parentSetSnackbarMessageType={setSnackbarMessageType} // Passer une référence de la méthode de changement de la variable d'état pour que l'enfant puisse la déclencher.
                parentSetIsSnackbarOpen={setIsSnackbarOpen} // Passer une référence de la méthode de changement de la variable d'état pour que l'enfant puisse la déclencher.
                adminEmail={selectedAdminEmail} // Passer l'email de l'admin dont on veut changer le mot de passe.
            />
