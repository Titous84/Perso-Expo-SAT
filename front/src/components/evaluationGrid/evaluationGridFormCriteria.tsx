          ...
          <Grid2 container spacing={2}>
            <Grid2 size={{ xs: 9, md: 9 }}>
              <TextValidator
                ...
                fullWidth
                onChange={(event: any) =>
                  this.props.handleChangeCriteria(
                    'name',
                    event.target.value,
                    this.props.sectionPosition,
                    this.props.criteriaPosition,
                  )
                }
                ...
                helperText={
                  !isValidName(this.props.criteria.name) &&
                  TEXTS.evaluationGridForm.criteriaName.error.required
                }
              ...
              <Grid2 size={{ xs: 9, md: 9 }}>
                <TextField
                  ...
                  helperText={
                    !isValidNumber(this.props.criteria.max_value) &&
                    TEXTS.evaluationGridForm.criteriaMaxValue.error.maximum
                  }
                />
                <br />
                <br />
              ...
              <ButtonExposat
                onClick={() =>
                  this.props.removeCriteria(
                    this.props.sectionPosition,
                    this.props.criteria.position,
                  )
                }
                children={'- Supprimer le critère'}
              />
            </Grid2>
          </Grid2>
        );
