    ...
    generateAlert(){
        ...
        if(this.state.error.length > 0){
           ...
           return (
             <Navigate
               replace
               to="/administration?onglet=modeles-grilles-evaluation"
             /> // Bugifx : Redirige vers la page de liste des modèles de grilles d'évaluation après une création ou une modification réussie
