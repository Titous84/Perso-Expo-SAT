...
use App\Actions\SignUpContactPersonAction\GetContactPersonsAction;
...
use App\Actions\TeamsList\AddCategories;
use App\Actions\TeamsList\UpdateCategories;
use App\Actions\TeamsList\DeleteCategories;
// Sondages (Surveys)
...
$app->group('/api', function (RouteCollectorProxy $group) {
	...
	$group->group('/signup', function (RouteCollectorProxy $signUpGroup) {
		...
		/**
		 * Page permettant d'obtenir les personnes-ressources pour l'inscription d'une équipe
		 * @author  Léandre Kanmegne - H26
		 * */ 
		$signUpGroup->get('/contact-persons', GetContactPersonsAction::class);
	...
	$group->group('/gestion-equipes', function (RouteCollectorProxy $teamsListGroup) {
		...
		/**
		 * @author Breno Gomes, Morgan Boissonneault - H26
		 * Routes pour la gestion des catégories d'équipes
		 */

		//Permet d'ajouter une catégorie d'équipe
		$teamsListGroup->post("/categories", AddCategories::class);

		//Permet de mettre à jour une catégorie d'équipe
		$teamsListGroup->patch("/categories/{id}", UpdateCategories::class);

		//Permet de supprimer une catégorie d'équipe
		$teamsListGroup->delete("/categories", DeleteCategories::class);
