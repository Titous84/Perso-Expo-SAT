...
/**
 * Classe permettant de supprimer les catégories.
...
{	
    ...
    /**
     * Constructeur de la classe DeleteCategories
     *
    ...
    public function __invoke(Request $request, Response $response, $args): ResponseInterface
    {
        ...
        $teamsList = $this->teamsListService->delete_categories($request->getParsedBody());
