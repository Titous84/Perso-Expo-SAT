...
/**
 * Classe permettant de récupérer les tout les juges.
 * @author Thomas-Gabriel Paquin
 * @package App\Actions\Judge
 */
class GetJudgesAction
{
    private UserService $judgeService;
    private TokenService $tokenService;

    /**
     * Constructeur de la classe GetJudgesAction
     * @author Thomas-Gabriel Paquin
    ...
    public function __invoke(Request $request, Response $response, array $args): ResponseInterface
    {
        ...
        $blacklisted = $request->getAttribute("blacklisted");

        $judge = $this->judgeService->get_all_judges($blacklisted);
