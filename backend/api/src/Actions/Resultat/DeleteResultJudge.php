...
{	
	 ...
	 * Bugfix : Permet de supprimer les notes d'un juge pour une équipe spécifique en appelant la fonction delete_judge_resultat du service ResultatService, et retourne le résultat de l'opération.
	...
	public function __invoke(Request $request, Response $response): ResponseInterface
	{
		...
		$judgeId = (int) ($queryParams['judgeId'] ?? 0);
