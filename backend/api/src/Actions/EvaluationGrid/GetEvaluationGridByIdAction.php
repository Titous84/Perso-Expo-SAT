...
/**
 * Classe permettant de récupérer une grille d'évaluation par son id.
 * @author Raphaël Boisvert
 *
 */
class GetEvaluationGridByIdAction
{
    ...
    public function __invoke(Request $request, Response $response, array $args): ResponseInterface
    {
        ...
        $evaluationGrid = $this->evaluationGridService->getEvaluationGridById($args['id']);
