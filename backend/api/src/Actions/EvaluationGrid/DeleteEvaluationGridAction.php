...
/**
 * Classe permettant de supprimer une grille d'évaluation.
 * @author Raphaël Boisvert
 *
 */
class DeleteEvaluationGridAction
{
    ...
    public function __invoke(Request $request, Response $response, array $args): ResponseInterface
    {
        ...
        $evaluationGrid = $this->evaluationGridService->deleteEvaluationGridById($args['id']);
