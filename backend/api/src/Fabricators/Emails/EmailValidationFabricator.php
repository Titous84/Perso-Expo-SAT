...
class EmailValidationFabricator
{
    ...
    /**
     * @var LogHandler $logHandler Gestionnaire de log.
	 * Bugfix @author Léandre Kanmegne H-26
	 * Ajout de la déclaration de la variable $logHandler pour éviter les erreurs d'accès
     */
    private $logHandler;
	 ...
	 * @param LogHandler $logHandler Gestionnaire de log.
	 */
    public function __construct(EmailService $emailService,TwigService $twigService, LogHandler $logHandler)
	{
