...
class UserService
{
	 ...
	 */
	private ValidatorUserRole $validatorUserRole;
     ...
     */
    private ValidatorAdministrator $validatorAdministrator;

	/**
	 * @var ValidatorJudge Validateur qui permet de vérifier un judge.
	 */
	private ValidatorJudge $validatorJudge;
	...
	public function add_user(array $userJSON): Result
	{
		try {
			...
			if ($user->role_id == 0) {
				...
				$emailEnvoyer = $this->send_email_judges();
				if ($emailEnvoyer != null) {
					return $emailEnvoyer;
				}
			}
