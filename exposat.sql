...
ALTER TABLE
  `users`
ADD
  COLUMN `is_anonymous` TINYINT(1) NOT NULL DEFAULT 0
AFTER
  `picture_consent`,
ADD
  COLUMN `photo_consent_clause` ENUM('publication', 'usage_interne', 'refus_total') NOT NULL DEFAULT 'refus_total'
AFTER
  `is_anonymous`;
